...
## Required Skills (Pre-load before refactoring)

Before refactoring code, read and apply patterns from:
- `.claude/skills/coding-standards/SKILL.md` → Code quality, naming, structure
