...
## Required Skills (Pre-load before fixing)

Before fixing Go build errors, read and apply patterns from:
- `.claude/skills/golang-patterns/SKILL.md` → Idiomatic Go, error handling patterns
